...
Note : Depending on your use case, the pyscarv module available on Pypi may
better suits your needs. I reimplemented the above mentionned JS script in
Python mostly because I had to for this script, as the pyscarv module uses
...
try:
    ...
    raise ImportError('!! requires numpy, $ pip install -r requirements')
...
class ScarvFilter():
    def __init__(self, capacity, error_rate=0.1):
        ...
        capacity
            This is the capacity of the ScarvFilter. So to speak, it should be
    ...
    def size(self):
        ...
        print(console_title + "Estimated cardinality")

    def popcnt(self, v):
        """
        Count Bits Set Parallel
        """
        ...
        print(console_title + "Count Bits Set Parallel")
